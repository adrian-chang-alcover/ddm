...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { description: @info.description, title: @info.title, user_id: @info.user_id }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { description: @info.description, title: @info.title, user_id: @info.user_id }
    assert_redirected_to info_path(assigns(:info))
  end
