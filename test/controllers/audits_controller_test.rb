...
class AuditsControllerTest < ActionController::TestCase
  ...
  test "should create audit" do
    assert_difference('Audit.count') do
      post :create, audit: { event: @audit.event, item_id: @audit.item_id, item_type: @audit.item_type, object: @audit.object, whodunnit: @audit.whodunnit }
    end
  ...
  test "should update audit" do
    patch :update, id: @audit, audit: { event: @audit.event, item_id: @audit.item_id, item_type: @audit.item_type, object: @audit.object, whodunnit: @audit.whodunnit }
    assert_redirected_to audit_path(assigns(:audit))
  end
